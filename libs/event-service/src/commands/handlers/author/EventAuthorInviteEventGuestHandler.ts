...
import { EventAuthorInviteEventGuestCommand } from '../../impl';
...
export class EventAuthorInviteEventGuestHandler implements ICommandHandler<EventAuthorInviteEventGuestCommand> {
  ...
  async execute(command: EventAuthorInviteEventGuestCommand) {
    try {
      ...
      this.eventBus.publish(
        new EventAuthorInviteEventGuestEvent(invitation, accessToken),
      );
