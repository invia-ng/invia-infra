...
<body>
  <div class="main-content">
    <div class="email-container">
      ...
      <div class="content">
        <p>Hello,<br><br>
          We wanted to let you know that the password for your Invia account has been successfully reset. If you made this change, no further action is required. If you didn't reset your password, please contact our support team immediately to secure your account.
        </p>
        ...
        <br/>
        <p>Best regards,<br>Team Invia.</p>
      </div>
  </div>
</body>
</html>
