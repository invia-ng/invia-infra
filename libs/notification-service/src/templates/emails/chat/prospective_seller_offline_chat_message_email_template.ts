export const prospectiveSellerOfflineChatMessageEmailTemplate = (
  ...
  <body>
      <div class="main-content">
          <div class="email-container">
              ...
              <h1 class="header">Prospective Seller Message</h1>
  
              <div class="content">
                  <p>Hello ${recipientName}, <br><br>
                  You have a message via chat from a seller named ${sellerName}. Please check your chat messages to view the message via your account.</p>
